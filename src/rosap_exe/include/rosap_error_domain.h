 ...
 *
 *********************************************************************************************************************/
#ifndef SRC_HELLO_WORLD_HELLO_WORLD_ERROR_DOMAIN_H_
#define SRC_HELLO_WORLD_HELLO_WORLD_ERROR_DOMAIN_H_
...
/*!
 * \brief Enumeration for all Error Code values of the Hello World example.
 */
enum class HelloWorldErrc : ara::core::ErrorDomain::CodeType { kUnknownError = 0, kThreadCreationFailed = 1 };

/*!
 * \brief An interface of the Template Exception.
 */
class HelloWorldException : public ara::core::Exception {
 public:
 ...
 * \details This class represents an error domain responsible for all errors occurring in the Hello World example.
 */
class HelloWorldErrorDomain final : public ara::core::ErrorDomain {
 public:
  /*!
   ...
   */
  using Errc = HelloWorldErrc;

  /*!
   * \brief Constructor for TemplateErrorDomain.
   */
  constexpr HelloWorldErrorDomain() noexcept : ErrorDomain(kId) {}

  /*!
   * \brief Return the name for this error domain.
   * \return The name as a null-terminated string, never nullptr.
   */
  StringType Name() const noexcept final { return "HelloWorldExample"; };
  ...
  [[noreturn]] void ThrowAsException(const ara::core::ErrorCode& error_code) const noexcept(false) {
    vac::language::ThrowOrTerminate<HelloWorldException>(error_code);
  }
};
 ...
 */
constexpr HelloWorldErrorDomain kTemplateErrorDomain;
}  // namespace internal
 ...
 */
inline constexpr ara::core::ErrorCode MakeErrorCode(HelloWorldErrorDomain::Errc code,
...
#endif  // SRC_HELLO_WORLD_HELLO_WORLD_ERROR_DOMAIN_H_
