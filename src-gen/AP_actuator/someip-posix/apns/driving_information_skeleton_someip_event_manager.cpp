 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_actuator/someip-posix/apns/driving_information_skeleton_someip_event_manager.cpp
...
driving_informationSkeletonSomeIpEventManagervehicle_speed::driving_informationSkeletonSomeIpEventManagervehicle_speed(
    driving_informationSkeletonSomeIpBinding& skeleton_binding, amsr::com_common::internal::memory::MemoryBufferAllocator& tx_buffer_allocator)
...
void driving_informationSkeletonSomeIpEventManagervehicle_speed::Send(const apns::speedtype& data) {
  ...
  header.service_id_ = driving_informationSkeletonSomeIpBinding::kServiceId;
  header.method_id_ = 0x8001U;
    ...
    // CppImplDataTypeStruct serialization for element 'data' (/turtlesim/ServiceDesign/datatype/speedtype)
{
  ...
  if (serialization_status == ::amsr::com_common::internal::serialization::SerializerStatus::kOk) {
    ...
    const char* error_msg{"Memory allocation for event notification of 'driving_information::vehicle_speed' failed."};
    ...
    const char* error_msg{"Serialization of event notification of 'driving_information::vehicle_speed' failed."};
    logger_.LogError([&error_msg](ara::log::LogStream& s) { s << error_msg; }, __func__, __LINE__);
...
driving_informationSkeletonSomeIpEventManagervehicle_position::driving_informationSkeletonSomeIpEventManagervehicle_position(
    driving_informationSkeletonSomeIpBinding& skeleton_binding, amsr::com_common::internal::memory::MemoryBufferAllocator& tx_buffer_allocator)
    : skeleton_binding_(skeleton_binding),
      tx_buffer_allocator_(tx_buffer_allocator),
      logger_(amsr::com_common::internal::logging::kSomeIpLoggerContextId, amsr::com_common::internal::logging::kSomeIpLoggerContextDescription,
...
void driving_informationSkeletonSomeIpEventManagervehicle_position::Send(const apns::locationtype& data) {
    namespace common_marshalling = ::amsr::com_common::internal::serialization;
    ...
    // CppImplDataTypeStruct serialization for element 'data' (/turtlesim/ServiceDesign/datatype/locationtype)
{
  ...
  {
    ::amsr::com_common::internal::serialization::Serializer<someip_marshalling::BEPayloadNoLengthFieldPolicy, decltype(serializer_data)> serializer_data_x{&serializer_data};
  ...
  {
    ::amsr::com_common::internal::serialization::Serializer<someip_marshalling::BEPayloadNoLengthFieldPolicy, decltype(serializer_data)> serializer_data_y{&serializer_data};
  ...
  {
    ::amsr::com_common::internal::serialization::Serializer<someip_marshalling::BEPayloadNoLengthFieldPolicy, decltype(serializer_data)> serializer_data_theta{&serializer_data};
  ...
  if (serialization_status == ::amsr::com_common::internal::serialization::SerializerStatus::kOk) {
    ...
    // Memory allocation failed.
    const char* error_msg{"Memory allocation for event notification of 'driving_information::vehicle_position' failed."};
    logger_.LogError([&error_msg](ara::log::LogStream& s) { s << error_msg; }, __func__, __LINE__);
    throw ::ara::com::InternalComException(::ara::com::InternalComErrc::insufficient_memory, error_msg);
  } else {
    // Memory allocation was ok, but serialization failed.
    const char* error_msg{"Serialization of event notification of 'driving_information::vehicle_position' failed."};
    logger_.LogError([&error_msg](ara::log::LogStream& s) { s << error_msg; }, __func__, __LINE__);
    throw ::ara::com::InternalComException(::ara::com::InternalComErrc::serialization_error, error_msg);
  }
}
