 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_actuator/includes/apns/speed_control_resource_manager.h
...
#ifndef AP_ACTUATOR_INCLUDES_APNS_SPEED_CONTROL_RESOURCE_MANAGER_H_
#define AP_ACTUATOR_INCLUDES_APNS_SPEED_CONTROL_RESOURCE_MANAGER_H_
...
class speed_controlResourceManager final {
 public:
  ...
  /*!
   * \brief Get resource manager for service 'speed_control' proxy
   * \return Resource manager for service 'speed_control' proxy
   */
  speed_controlProxyResourceManager& GetProxyResourceManager();

 private:
  /*!
   * \brief Resource manager for service 'speed_control' proxy
   */
  speed_controlProxyResourceManager proxy_resource_manager_;
...
#endif  // AP_ACTUATOR_INCLUDES_APNS_SPEED_CONTROL_RESOURCE_MANAGER_H_
