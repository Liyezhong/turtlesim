 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_actuator/includes/apns/driving_information_skeleton_resource_manager.h
...
#ifndef AP_ACTUATOR_INCLUDES_APNS_DRIVING_INFORMATION_SKELETON_RESOURCE_MANAGER_H_
#define AP_ACTUATOR_INCLUDES_APNS_DRIVING_INFORMATION_SKELETON_RESOURCE_MANAGER_H_
...
#endif  // AP_ACTUATOR_INCLUDES_APNS_DRIVING_INFORMATION_SKELETON_RESOURCE_MANAGER_H_
