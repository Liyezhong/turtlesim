 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_actuator/includes/apns/impl_type_speedtype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef AP_ACTUATOR_INCLUDES_APNS_IMPL_TYPE_SPEEDTYPE_H_
#define AP_ACTUATOR_INCLUDES_APNS_IMPL_TYPE_SPEEDTYPE_H_
...
#endif  // AP_ACTUATOR_INCLUDES_APNS_IMPL_TYPE_SPEEDTYPE_H_
