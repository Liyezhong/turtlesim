 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_actuator/includes/apns/impl_type_locationtype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef AP_ACTUATOR_INCLUDES_APNS_IMPL_TYPE_LOCATIONTYPE_H_
#define AP_ACTUATOR_INCLUDES_APNS_IMPL_TYPE_LOCATIONTYPE_H_
...
#endif  // AP_ACTUATOR_INCLUDES_APNS_IMPL_TYPE_LOCATIONTYPE_H_
