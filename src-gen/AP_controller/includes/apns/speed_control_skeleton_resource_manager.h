 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_controller/includes/apns/speed_control_skeleton_resource_manager.h
...
#ifndef AP_CONTROLLER_INCLUDES_APNS_SPEED_CONTROL_SKELETON_RESOURCE_MANAGER_H_
#define AP_CONTROLLER_INCLUDES_APNS_SPEED_CONTROL_SKELETON_RESOURCE_MANAGER_H_
...
#endif  // AP_CONTROLLER_INCLUDES_APNS_SPEED_CONTROL_SKELETON_RESOURCE_MANAGER_H_
