 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_controller/includes/apns/driving_information_resource_manager.h
...
#ifndef AP_CONTROLLER_INCLUDES_APNS_DRIVING_INFORMATION_RESOURCE_MANAGER_H_
#define AP_CONTROLLER_INCLUDES_APNS_DRIVING_INFORMATION_RESOURCE_MANAGER_H_
...
class driving_informationResourceManager final {
 public:
  ...
  /*!
   * \brief Get resource manager for service 'driving_information' proxy
   * \return Resource manager for service 'driving_information' proxy
   */
  driving_informationProxyResourceManager& GetProxyResourceManager();

 private:
  /*!
   * \brief Resource manager for service 'driving_information' proxy
   */
  driving_informationProxyResourceManager proxy_resource_manager_;
...
#endif  // AP_CONTROLLER_INCLUDES_APNS_DRIVING_INFORMATION_RESOURCE_MANAGER_H_
