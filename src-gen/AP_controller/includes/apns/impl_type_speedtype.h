 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_controller/includes/apns/impl_type_speedtype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef AP_CONTROLLER_INCLUDES_APNS_IMPL_TYPE_SPEEDTYPE_H_
#define AP_CONTROLLER_INCLUDES_APNS_IMPL_TYPE_SPEEDTYPE_H_
...
#endif  // AP_CONTROLLER_INCLUDES_APNS_IMPL_TYPE_SPEEDTYPE_H_
