 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_controller/includes/apns/speed_control.h
...
#ifndef AP_CONTROLLER_INCLUDES_APNS_SPEED_CONTROL_H_
#define AP_CONTROLLER_INCLUDES_APNS_SPEED_CONTROL_H_
...
#endif  // AP_CONTROLLER_INCLUDES_APNS_SPEED_CONTROL_H_
