 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  AP_controller/includes/ara/com/resource_manager.h
...
#ifndef AP_CONTROLLER_INCLUDES_ARA_COM_RESOURCE_MANAGER_H_
#define AP_CONTROLLER_INCLUDES_ARA_COM_RESOURCE_MANAGER_H_
...
#include "ara/com/ipc_resource_manager.h"
...
class ResourceManager final {
 public:
  ...
  /*!
   * \brief Get resource manager for binding 'Ipc'
   * \return Reference to resource manager for binding 'Ipc'
   */
  ::amsr::socal::internal::IpcResourceManager& GetIpcResourceManager();
 ...
 private:
  ...
  /*!
   * \brief Resource manager for service 'apns::external_elements'
   */
  apns::resources::external_elementsResourceManager apns_external_elements_resource_manager_;
  ...
  /*!
   * \brief Resource manager for binding 'Ipc'
   */
  IpcResourceManager ipc_resource_manager_;
...
#endif  // AP_CONTROLLER_INCLUDES_ARA_COM_RESOURCE_MANAGER_H_
