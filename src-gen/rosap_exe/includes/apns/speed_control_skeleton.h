 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  rosap_exe/includes/apns/speed_control_skeleton.h
...
#ifndef ROSAP_EXE_INCLUDES_APNS_SPEED_CONTROL_SKELETON_H_
#define ROSAP_EXE_INCLUDES_APNS_SPEED_CONTROL_SKELETON_H_
...
#endif  // ROSAP_EXE_INCLUDES_APNS_SPEED_CONTROL_SKELETON_H_
