 ...
 *  FILE DESCRIPTION
 *  -----------------------------------------------------------------------------------------------------------------*/
/**        \file  rosap_exe/includes/apns/impl_type_lanetype.h
 *        \brief
 *
 *      \details
 *
...
#ifndef ROSAP_EXE_INCLUDES_APNS_IMPL_TYPE_LANETYPE_H_
#define ROSAP_EXE_INCLUDES_APNS_IMPL_TYPE_LANETYPE_H_
...
#endif  // ROSAP_EXE_INCLUDES_APNS_IMPL_TYPE_LANETYPE_H_
